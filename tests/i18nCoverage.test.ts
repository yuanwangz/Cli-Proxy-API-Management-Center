...
const PROVIDER_FORM_KEYS = [
  ...
  'form.thinkingLevels.none',
  'form.thinkingLevels.minimal',
  'form.thinkingLevels.low',
  'form.thinkingLevels.medium',
  'form.thinkingLevels.high',
  'form.thinkingLevels.xhigh',
  'form.thinkingLevels.max',
  'form.thinkingLevels.auto',
