          ...
          {!isRuntimeOnly && (
            <div className={styles.utilityActions}>
              ...
              <Button
                ...
                disabled={disableControls || deleting === identityKey || isManualRefreshing}
              >
                {deleting === identityKey ? <LoadingSpinner size={14} /> : <IconTrash2 size={15} />}
              </Button>
            </div>
          )}
        </div>
        {!isRuntimeOnly && (
          <div className={styles.toggleWrap}>
            ...
            <ToggleSwitch
              ...
              disabled={
                disableControls || statusUpdating[identityKey] === true || isManualRefreshing
              }
